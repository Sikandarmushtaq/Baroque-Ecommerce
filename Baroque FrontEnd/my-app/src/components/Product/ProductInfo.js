...
const ProductInfo = ({ product }) => {
  ...
  return (
    <div>
      ...
      <h1 className="mt-5 text-4xl leading-tight tracking-wide">
        {product.name}
      </h1>
      ...
      <div className="mt-10">
        <p className="uppercase tracking-[3px] text-sm mb-4">Quantity</p>

        <div className="flex w-[150px] h-[55px] border">
          <button onClick={decreaseQuantity} className="flex-1 text-2xl">
            -
          </button>

          <div className="flex items-center justify-center flex-1 border-x">
            {quantity}
          </div>

          <button onClick={increaseQuantity} className="flex-1 text-2xl">
            +
          </button>
        </div>
      </div>
