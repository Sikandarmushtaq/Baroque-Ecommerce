        ...
        {products.map((product) => (
          ...
          >
            ...
            <div className="relative overflow-hidden">
              ...
              <button
                className="absolute flex items-center justify-center w-8 h-8 bg-white rounded-full top-2 left-2 sm:top-4 sm:left-4 sm:w-11 sm:h-11"
              >
            ...
            <div className="mt-3 sm:mt-6">
              ...
              <h2 className="mt-1.5 sm:mt-3 text-sm sm:text-[19px] tracking-wide truncate">
                {product.name}
              </h2>
